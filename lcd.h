...
#define LCD_ENABLE_ON	(LCD_CONTROL = (lcd_con|=0x04)) // 00000100
#define LCD_ENABLE_OFF	(LCD_CONTROL = (lcd_con&=0x0b)) // 00001011
#define LCD_R_W_ON	(LCD_CONTROL = (lcd_con|=0x02)) 	// 00000010
#define LCD_R_W_OFF	(LCD_CONTROL = (lcd_con&=0x0d))		// 00001101
#define LCD_RS_ON	(LCD_CONTROL = (lcd_con|=0x01))		// 00000001
#define LCD_RS_OFF	(LCD_CONTROL = (lcd_con&=0x0e))		// 00001110
